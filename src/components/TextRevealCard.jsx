...
export const TextRevealCard = ({ text, revealText, children, className }) => {
  ...
  return (
    <div
      ...
      ref={cardRef}
      className={cn(
        "bg-[#121212] max-w-[60rem]  sm:w-[60rem] rounded-lg  relative overflow-hidden",
        className
      )}
    >
      {children}
      ...
      <div className="  relative flex justify-center items-center overflow-hidden">
        ...
        <div className=" overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)]">
          <p className="text-base sm:text-[3rem] py-10 font-bold bg-clip-text text-transparent bg-[#6b7280]">
            {text}
          </p>
          <MemoizedStars />
        </div>
