    ...
    <div className='h-[50vh] grid md:grid-cols-2 gap-4 mt-4 '>
     <WobbleCard >
        <div className='z-10 absolute top-0 left-0 flex items-center justify-center w-full h-full mx-auto'>
         ...
         <img className='z-20 absolute h-full w-full aspect-auto m-4 object-contain  '  src="/images/tutahua.png" alt="" />
        </div>
     ...
     <WobbleCard className={`bg-blue-800`}>
       <div className='z-10 absolute top-0 left-0 flex items-center justify-center w-full h-full mx-auto'>
         ...
         <img className='z-20 absolute h-full w-full sm:left-52 left-28  aspect-auto m-4  object-contain  '  src="/images/deadpool.png" alt="" />
        </div>
